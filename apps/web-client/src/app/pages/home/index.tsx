...
import { FolderContent } from '@/types/aliases';
 ...
 */
const HomePage = () => {
  const categories = useLoaderData() as NonNullable<
    FolderContent['subCategories']
  >;
