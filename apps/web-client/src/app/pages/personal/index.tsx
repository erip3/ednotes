...
import { FolderContent, Project } from '@/types/aliases';
...
export const clientLoader = (queryClient: QueryClient) => async () => {
  ...
  const categories =
    (queryClient.getQueryData<FolderContent>(categoriesQuery.queryKey) as
      | FolderContent
      | undefined) ??
...
const PersonalPage = () => {
  const { categories, projects } = useLoaderData() as {
    categories: NonNullable<FolderContent['subCategories']>;
