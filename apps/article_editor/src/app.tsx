...
export const App: React.FC = () => {
  ...
  const [currentArticle, setCurrentArticle] = useState<ArticleResponse | null>(
    null,
  );
    ...
    try {
      const articleContext =
        ...
        (currentArticleId != null
          ...
          : null);
      const savedArticle = await uploadToDB(blocks, metadata, articleContext);
      setCurrentArticle(savedArticle);
      if (savedArticle.id != null) {
        setCurrentArticleId(savedArticle.id);
        setArticleIdInput(String(savedArticle.id));
      }
