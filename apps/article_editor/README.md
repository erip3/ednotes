...
- `POST /api/editor/articles` - Create new article
- `GET /api/editor/articles/{id}` - Fetch article
- `PUT /api/editor/articles/{id}` - Update article
- `GET /api/navigation/roots` - Load top-level categories
- `GET /api/navigation/categories/{id}` - Load child categories
